...
export default class ProductsDetailTable extends React.Component {

    constructor(props) {
        super(props);

        this.state = { product_name: this.props.product_name, details: [], totalDetails: 0, isLoading: true, rowsPerPage: 5, page: 0, sortColumn: 'termCreatedDate', sortOrder: 'desc' };
    ...
    retrieveStudentDetail(sortColumn, sortOrder, page, rowsPerPage, constructorCall = false) {
        ...
        ProductsHttpClient.getStudentDetail(this.props.product_name, sortColumn, sortOrder, page, rowsPerPage)
            .then(response => {
